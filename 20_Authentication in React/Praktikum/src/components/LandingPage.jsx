...
export default function LandingPage() {
  ...
  return (
    <>
      {/* Header */}
      <nav className="flex justify-between items-center p-6 text-black">
        <h2 className="text-xl font-bold">Simple Header</h2>
        <ul className="flex space-x-4">
          ...
          <li>
          <a onClick={goToCreateProduct} className="cursor-pointer hover:text-blue-400">
              Create Product
            </a>
          </li>
          <li>
